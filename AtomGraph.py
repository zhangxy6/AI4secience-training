...
def main(data_dir, output_path,name_database ,cutoff,max_num_nbr,compress_ratio,chunk_size=13172):
    ...
    if name_database=='MP':
        ...
        print (data_files)
    for n, chunk in enumerate(tqdm(py_.chunk(data_files[:int(compress_ratio*len(data_files))],13172))):
        graph_names = []
        graph_lattice=[]
        graph_nodes= []
        graph_edges = []
